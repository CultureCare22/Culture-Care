                ...
                <div class="flex-container-outer">
                    ...
                    <div class="comfirmation_box">
                        ...
                        <div className='updateStatus'>
                            <div className='flex-container-pr'>
                                <div className='titlePR'>Please accept or reject the request: </div>
                                <div className='update-status-buttons'>
                                    ...
                                    <svg width="25" height="25" viewBox="0 0 65 65" fill="none" className='decline' xmlns="http://www.w3.org/2000/svg">
                                        <a href="/appt-declined">
